(() => {
  let app = {
    ...
    lista: "https://picsum.photos/v2/list?page=3&limit=8",
    ...
    cliqueImagem: function(event){
      const p = e.target.getAttribute("data-valor");
      e.target.src = `${this.imagemEspecifica}${p}/${this.tamanhoImagem}`
